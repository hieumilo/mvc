...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <h1 class="text-center">Create work</h1>
            <form action="/work" method="POST" id="create-form">
                <div class="form-group">
                    <label for="name">Work name</label>
                    <input type="text" class="form-control" id="name" name="work_name" placeholder="Enter work name" required>
                </div>
                <div class="form-group">
